			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="footer-logo">
						<a href="index.html"><img src="{{ asset('frontend-assets/assets/images/logoFooterSCTBangla.svg')}}" alt=""></a>
					</div>
					<div class="footer-widget-desc">
						<p>Our commitment to quality and customer satisfaction makes us a trusted partner in building
							scalable and robust software applications.</p>
					</div>
				...
				<div class="col-lg-2 col-md-6">
					<div class="footer-widget-content">
						...
						<div class="footer-widget-menu">
							<ul>
								<li><a href="{{ route('about') }}"><i class="bi bi-arrow-right-circle"></i>About</a></li>
								<li><a href="{{ route('team') }}"><i class="bi bi-arrow-right-circle"></i>Our Team</a></li>
								<li><a href="{{ route('contact') }}"><i class="bi bi-arrow-right-circle"></i>Contact Us </a></li>
								<li><a href="{{ route('blog') }}"><i class="bi bi-arrow-right-circle"></i>Latest Blog</a>
								</li>
								<li><a href="{{ route('careers') }}"><i class="bi bi-arrow-right-circle"></i>Careers</a></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-6 col-md-6">
							<div class="footer-bottom-content">
								<p>© 2024 SCT. Designed By SCT BANGLA LTD.</p>
							</div>
						</div>
						<div class="col-lg-6 col-md-6">
